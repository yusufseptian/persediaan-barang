	...
	//if ($_GET["module"]=="barang" || $_GET["module"]=="form_barang") { ?>
		<!-- <li class=" treeview">
      		...
      		<ul class="treeview-menu">
        		<li class=""><a href="?module=barang"><i class="fa fa-circle-o"></i> Data Barang</a></li>
	...
	//elseif ($_GET["module"]=="jenis" || $_GET["module"]=="form_jenis") { ?>
		<!-- <li class=" treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li class=""><a href="?module=jenis"><i class="fa fa-circle-o"></i> Jenis Barang</a></li>
        		<li><a href="?module=satuan"><i class="fa fa-circle-o"></i> Satuan</a></li>
      		</ul>
    	</li> -->
    <?php
	...
	//elseif ($_GET["module"]=="lap_barang_masuk") { ?>
		<!-- <li class=" treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li class=""><a href="?module=lap_barang_masuk"><i class="fa fa-circle-o"></i> Barang Masuk</a></li>
        		<li><a href="?module=lap_barang_keluar"><i class="fa fa-circle-o"></i> Barang Keluar</a></li>
      		</ul>
    	</li> -->
    <?php
