        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $query = mysqli_query($mysqli, "SELECT * FROM is_satuan WHERE deleted_date is null ORDER BY id_satuan DESC")
              ...
              ?>
                <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="<?php echo base_url() ?>satuan/delete?act=delete&id=<?php echo $data['id_satuan']; ?>" onclick="return confirm('Anda yakin ingin menghapus satuan barang <?php echo $data['nama_satuan']; ?> ?');">
