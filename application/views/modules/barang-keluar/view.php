                ...
                if (isAdmin() or isStaffGudang()) {
                  ...
                  if ($data['status'] == 'Proses') {
                    echo "<td class='center' width='110'>
                          <a data-toggle='tooltip' data-placement='top' title='Approve' style='margin-right:5px' class='btn btn-success btn-sm' href='" . base_url() . "barang_keluar/approve?act=approve&id=$data[id_barang_keluar]&jml=$data[jumlah_keluar]&idb=$data[id_barang]&stok=$data[stok]'>
                              <i style='color:#fff' class='glyphicon glyphicon-ok'></i>
                          </a>

                          <a data-toggle='tooltip' data-placement='top' title='Reject' style='margin-right:5px' class='btn btn-danger btn-sm' href='" . base_url() . "barang_keluar/reject?act=reject&id=$data[id_barang_keluar]'>
