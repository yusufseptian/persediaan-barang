<script type="text/javascript">
  function tampil_barang(input){
    ...
    $.post("<?php echo base_url()?>barang_masuk/cek_barang", {
      dataidbarang: num,
    }, function(response) {      
      $('#stok').html(response)
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="<?php echo base_url()?>barang_masuk/input?act=insert" method="POST" name="formBarangMasuk">
            <div class="box-body">
              <?php  
