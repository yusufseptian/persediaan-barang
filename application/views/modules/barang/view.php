          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Safety Stok</th>
            ...
            $query = mysqli_query($mysqli, "SELECT a.id_barang,a.nama_barang,a.id_jenis,a.id_satuan,a.stok, a.safety_stok,b.id_jenis,b.nama_jenis,c.id_satuan,c.nama_satuan 
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='80' align='right'>$data[safety_stok]</td>
            ...
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="<?php echo base_url()?>barang/delete?act=delete&id=<?php echo $data['id_barang'];?>" onclick="return confirm('Anda yakin ingin menghapus barang <?php echo $data['nama_barang']; ?> ?');">
