    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="<?php echo base_url()?>barang/input?act=insert" method="POST">
            <div class="box-body">
              <?php  
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="safety_stok" autocomplete="off" required>
                </div>
              </div>
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT a.id_barang,a.nama_barang,a.id_jenis,a.id_satuan, a.safety_stok,b.id_jenis,b.nama_jenis,c.id_satuan,c.nama_satuan 
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="<?php echo base_url()?>barang/update?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Safety Stok</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="safety_stok" autocomplete="off" value="<?php echo $data['safety_stok']; ?>" required>
                </div>
              </div>
