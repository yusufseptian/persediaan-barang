    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="<?php echo base_url()?>user/save_data?act=insert" enctype="multipart/form-data">
            <div class="box-body">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="<?php echo base_url()?>user/update_data?act=update" enctype="multipart/form-data">
            <div class="box-body">
            ...
            <!--div class="form-group">
                ...
                <?php  
                if ($data['foto']=="") { ?>
                  <img style="border:1px solid #eaeaea;border-radius:5px;" src="<?php echo base_url()?>assets/images/user/user-default.png" width="128">
                <?php
                }
                else { ?>
                  <img style="border:1px solid #eaeaea;border-radius:5px;" src="<?php echo base_url()?>assets/images/user/<?php echo $data['foto']; ?>" width="128">
                <?php
                }
                ?>
                </div>
