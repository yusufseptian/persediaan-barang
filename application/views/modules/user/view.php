        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            // menampilkan isi tabel dari database ke tabel di aplikasi
              ...
              //         if ($data['foto']=="") { ?>
                        <!-- <td class='center'><img class='img-user' src='<?php echo base_url()?>assets/images/user/user-default.png' width='45'></td> -->
                      <?php
              //         } else { ?>
                         <!-- <td class='center'><img class='img-user' src='<?php echo base_url()?>assets/images/user/<?php echo $data['foto']; ?>' width='45'></td> -->
                      <?php
              //         }
              ...
              echo "  <td>$data[username]</td>
                      ...
                      <td class='center' width='100'>
                          ...
                          if ($data['status']=='aktif') { ?>
                            <a data-toggle="tooltip" data-placement="top" title="Blokir" style="margin-right:5px" class="btn btn-warning btn-sm" href="<?php echo base_url()?>user/change_block?act=off&id=<?php echo $data['id_user'];?>">
                                <i style="color:#fff" class="glyphicon glyphicon-off"></i>
                            </a>
            <?php
                          } 
                          else { ?>
                            <a data-toggle="tooltip" data-placement="top" title="Aktifkan" style="margin-right:5px" class="btn btn-success btn-sm" href="<?php echo base_url()?>user/change?act=on&id=<?php echo $data['id_user'];?>">
